# RailsAdmin config file. Generated on December 13, 2012 23:38
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Rails Girls Pair', 'Admin']
  ...
  # config.excluded_models = ['Authorization', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Authorization', 'User']
